...
<div class="mid_wrapper">
			...
			<section class="page-header ">
				<div class="page-header__bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/2024/05/cloud_application.webp);background-position: 50% 60%;"></div>
				<div class="container">
					<h2 class="page-header__title">
						Applications </h2><!-- /.page-title -->
					<ul class="vodanet-breadcrumb list-unstyled">
						...
						<li class="post post-page current-item">
							<span property="itemListElement" typeof="ListItem">
								<span property="name" class="post post-page current-item">Applications</span>
							</span>
						</li>
					...
					<div class="row gutter-y-30 mb-5 align-items-center">
						<div class="col-lg-4">
							<div class="about-three__left">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/2024/05/business-application.webp" width="auto" height="100%" alt="" style="object-fit: cover;width: auto;min-height: 280px;">
							</div>
						</div>
						<div class="col-lg-8">
							<div class="about-three__right">
								...
								<div class="about-three__link">
									<a href="business_application.html" class="about-three__link__btn vodanet-btn vodanet-btn--base">
										<span>Read More</span>
									</a>
								</div>
					...
					<div class="row gutter-y-30 mb-5 align-items-center flex-column-reverse flex-md-row">
						...
						<div class="col-lg-8 text-md-end">
							<div class="about-three__right">
								...
								<div class="about-three__link">
									<a href="cloud_application.html" class="about-three__link__btn vodanet-btn vodanet-btn--base">
										<span>Read More</span>
									</a>
								</div>
						...
						<div class="col-lg-4">
							<div class="about-three__left">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/2024/05/cloud2.webp" width="auto" height="100%" alt="" style="object-fit: cover;width: auto;min-height: 280px;">
							</div>
						</div>
					</div>
				</div>
